...
import AccommodationFormAccessibility from "components/accommodation/form/fields/AccommodationFormAccessibility";
...
export default AccommodationFormDetailedInformation;
