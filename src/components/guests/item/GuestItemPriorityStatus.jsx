...
const GuestItemPriorityStatus = () => {
    ...
    const colorFromStatus = {
        ...
        [GuestPriorityStatus.DOES_NOT_RESPOND]:
            "guest-priority-status-accommodation-not-needed",
    ...
    const labelFromStatus = {
        ...
        [GuestPriorityStatus.DOES_NOT_RESPOND]: t(
            "guest:priorityStatus.doesNotRespond"
        ),
    ...
    const statusBadgeColor =
        colorFromStatus[priorityStatus] || "guest-priority-status-unknown";
